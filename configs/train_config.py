...
class TrainConfiguration(BaseConfiguration):
    ...
    def initialize(self, parser):
        parser = BaseConfiguration.initialize(self, parser)
        # display parameters
        ...
        parser.add_argument('--save_epoch_freq', type=int, default=15, help='frequency of saving checkpoints at the end of epochs')
